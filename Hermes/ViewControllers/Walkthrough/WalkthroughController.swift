...
class WalkthroughController: BaseViewController {
    ...
    private var types: [WalkthroughType] = [.car, .address,.schedule, .enjoy]
    ...
    override func viewDidLoad() {
        ...
        setupViews()
        currentIndex = 0
        pageControl.numberOfPages = types.count
    }
...
extension WalkthroughController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
